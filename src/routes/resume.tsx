...
const Sidebar: Component = () => {
  return (
    <div class="shadow mb-4 grid gap-1 bg-gray-900 h-[inherit] text-center border-bottom border-b-10 border-pink-500">
      <div class="text-gray-900 relative h-[16rem]">
        <div class="bg-blue-400 h-[60%] p-2" />
        <img
